...
const db = spicedPg(process.env.DATABASE_URL || 'postgres:postgres:password@localhost:5432/arcade');
...
exports.insertUser = (data, password) => {
    return new Promise((resolve, reject) => {
        ...
        db.query(query, [data.first, data.last, data.email, password]).then((id) => {
